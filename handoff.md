...
- **버전**: v14.0 (package.json: v12.1.0 — 업데이트 필요)
...
└── src/
    ├── App.jsx           ← ★ 690줄 (App + MainApp + generateSeedData만 잔류)
    ...
    └── components/
        ...
        └── layout/
            └── NavLayout.jsx      ← 223줄 (BottomNav, Sidebar, MoreMenu, ShareButton, SidebarShareBtn)
```
...
## 현재 알려진 이슈
- `package.json` 버전이 여전히 `12.1.0` — 추후 `14.0.0`으로 업데이트 필요
